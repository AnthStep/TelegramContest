export default function (togglersContainer, text) {
	...
	htmlContainer
		.style
		.cssText = 'user-select: none; height: 35px; line-height: 35px; padding: 0 15px 0 35px; border: 1px solid #e8ecf0; border-radius: 17.5px; position: relative; display: inline-block; box-sizing: border-box; margin-right: 15px;color: #44484a; font-family: sans-serif; overflow: hidden';
